...
## Overview
This repository contains a reproducible pipeline to construct a biomedical literature corpus from PubMed and a derived dataset that wil be used for topic 2 of the MS thesis.
